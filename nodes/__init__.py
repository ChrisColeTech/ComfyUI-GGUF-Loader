...
from .ltx_reference import (NODE_CLASS_MAPPINGS as _LTX_REF_CLASSES,
                             NODE_DISPLAY_NAME_MAPPINGS as _LTX_REF_NAMES)

NODE_CLASS_MAPPINGS.update(_LTX_REF_CLASSES)
NODE_DISPLAY_NAME_MAPPINGS.update(_LTX_REF_NAMES)
